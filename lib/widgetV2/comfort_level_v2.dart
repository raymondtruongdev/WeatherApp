...
class ComfortLevelV2 extends StatelessWidget {
  final WeatherDataV2 weather;
  const ComfortLevelV2({Key? key, required this.weather}) : super(key: key);
            ...
            children: [
              Center(
                child: SleekCircularSlider(
                  ...
                  max: 100,
                  initialValue:
                      weather.getWeather().current?.humidity?.toDouble() ?? 0,
                    ...
                    text: TextSpan(children: [
                      const TextSpan(
                          ...
                          style: TextStyle(
                              ...
                              fontWeight: FontWeight.w400)),
                      TextSpan(
                          text: "${weather.getWeather().current?.uv ?? '--'}",
                          style: const TextStyle(
                              fontSize: 14,
                              height: 0.8,
                              color: CustomColors.textColorBlack,
